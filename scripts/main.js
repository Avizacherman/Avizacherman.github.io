				...
				theGrid[indexI].forEach(function(element, indexJ, array) {
					...
					$div.on('click', function() {
						...
						if ((player2 === 'AI' || player2 === 'Easy AI' || player2 === 'Hard AI') && turn === 'o') {
							...
							if (!whereToPlace) {
								return false
							} //if the computer doesn't take a turn
